...
namespace Sanveo.Common.Services
{
	...
	public class Messenger : IMessenger, IDisposable
	{
		...
		/// <summary>
		/// Resets the specified context.
		/// </summary>
		/// <param name="context">The context.</param>
		public void Reset(Type context = null)
		{
			if (context == null)
				_dictionary.Clear();
			else
			{
				...
				{
					if (item.Context.GetType() == context)
					{
						_dictionary.TryRemove(item, out object removed);
					}
				}
			}
		}
		...
		/// <param name="message">The message.</param>
		/// <param name="context">The context.</param>
		public async Task PublishAsync<T>(T message, object context)
		{
			IEnumerable<KeyValuePair<MessengerKey, object>> result;
